  ...
  return (
    <div className="min-h-screen bg-red-50 text-gray-900">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-10">
        <header className="space-y-4 rounded-3xl bg-red-600 px-6 py-8 text-white shadow-lg">
          <div>
        ...
        <main className="rounded-3xl bg-white p-6 shadow-md ring-1 ring-red-100 sm:p-8">
